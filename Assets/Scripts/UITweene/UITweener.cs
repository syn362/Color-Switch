...
namespace HivaGames.UnityUI.UITweene
{
    public abstract class UITweener : MonoBehaviour
    {
        ...
        {
            if (onFinished != null) onFinished.RemoveListener(del);
            if (mTemp != null) mTemp.RemoveListener(del);
        }
		...
		if ((object)comp == null) comp = (T)go.AddComponent<T>();
            ...
            if (comp == null)
            {
                ...
                if (comp == null)
                {
                    Debug.LogError("Unable to add " + typeof(T) + " to " + go, go);
                    return null;
                }
            }
#endif
